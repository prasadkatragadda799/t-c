...
document.addEventListener('DOMContentLoaded', () => {
    const toggleBtn = document.getElementById('programsToggleBtn');
    const programsGrid = document.querySelector('.programs-grid');

    if (toggleBtn && programsGrid) {
        toggleBtn.addEventListener('click', () => {
            ...
            if (isExpanded) {
                ...
                toggleBtn.innerHTML = 'View More Programs <span class="arrow">↓</span>';
                // Scroll back to programs section when collapsing
                programsGrid.scrollIntoView({ behavior: 'smooth', block: 'start' });
            }
        });
    }
});
